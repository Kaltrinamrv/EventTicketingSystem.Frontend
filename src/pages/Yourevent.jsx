...
const Yourevent = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('https://localhost:7161/api/Event'); // Replace with your API endpoint
    ...
    return (
      ...
      <div className="w-full bg-primary">
          ...
          <div className="flex md:px-[150px] xl:px-[200px] flex-wrap w-full bg-primary justify-center gap-6 py-6">
              {events.map((event) => (
                  <div key={event.id} className="border-purple border-2 rounded-lg w-[250px] h-[300px] p-4">
