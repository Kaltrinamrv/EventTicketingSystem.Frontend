    ...
    return (
        <main className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center mt-24">
                <h1 className="text-white text-3xl font-titles mb-4">Account Information</h1>
...
const AccountPage = () => {
    ...
    return (
        <main className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center mt-24">
                <h1 className="text-white text-3xl font-titles mb-10 mt-5">Account Information</h1> {/* Added margin top */}
                <div className="flex flex-col items-center">
                    <img 
                        src={ProfilePicture} 
                        alt="Profile" 
